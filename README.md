...
|---------|-------------|------|
| **BhagvadgitaGPT** | Full-stack AI app answering spiritual questions using the Bhagavad Gita as a knowledge base. Flask API backend + React/TypeScript (Vite) frontend. | [Live](http://bhagvadgitagpt-by-hj.netlify.app/) |
| **Government Document Management** | B.Tech Final Year Project — MERN stack website with Firebase OTP, Storage, and User Management. | [GitHub](https://github.com/harshj-1703/Government-Docs-Manager) |
| **Government Document Management App** | Flutter mobile app to verify government documents via QR Code scanning, companion to the web platform. | [GitHub](https://github.com/harshj-1703/Government-Docs-Manager-Flutter-App) |
| **HJ Donation** | Donation platform for underprivileged individuals using .NET, Entity Framework, and MSSQL. Includes admin panel and multi-photo item listings. | [GitHub](https://github.com/harshj-1703/HJ_Donation_.net) |
| **Student Interest Subject Choice ChatBot** | NLP AI project helping ICT students select elective subjects based on interests and descriptions. | [GitHub](https://github.com/harshj-1703/Student-Elective_Subject-Web-FLASK-AI) |
| **GET-SET-WORK** | Job-seeker and company connecting app built with Flutter and Firebase, featuring OTP verification and Google Ads. | — |
| **Shreemad Bhagavad Gita App** | Flutter app (Hindi & English) for accessing Bhagavad Gita teachings. Available on Play Store. | [Play Store](https://play.google.com/store/apps/details?id=com.shreemad_bhagvadgita.shreemad_bhagvadgita&hl=en) |
| **Chanakya GPT** | AI tool providing advice based on Chanakya Neeti, applying ancient wisdom to modern challenges. | [GitHub](https://github.com/harshj-1703/Chanakya-GPT) |
...
|-------------|--------|------|--------|
| **AWS Knowledge: Amazon Connect Communications Specialist** | Amazon Web Services (AWS) | May 2026 | [Verify](https://www.credly.com/badges/d5a636b4-2956-40a3-adf7-5eacd051064a) |
| **AWS Certified Cloud Practitioner** | Amazon Web Services (AWS) | Feb 2026 · Expires Feb 2029 | [Verify](https://www.credly.com/badges/93836703-4772-42d2-b6d9-97477fc2a85b) |
| **Fundamentals of MCP & MCP Automation in Production** | Hugging Face | Mar 2026 | [Verify](https://huggingface.co/datasets/mcp-course/certificates/resolve/main/certificates/harshj-1703/2026-03-04.png) |
| **ISRO Space Start Program** | ISRO | Aug 2023 | — |
| **Runner-up — Aazadi ka Amrit Mahotsav SSIP Hackathon** | SSIP Gujarat | 2022 | — |
| **Google Cloud Ready Facilitator Program — 3rd Milestone** | Google | — | — |
| **Machine Learning with Python** | Cognitive Class (IBM) | — | — |
| **Student Interest Group — Leadership, Goal Setting & Change Management** | SIG | — | — |

---

<h2 align="left">📜 Patents & Copyrights:</h2>

| Title | Type | Description |
|-------|------|-------------|
| **GetSetWork Application** | Copyright | A job-seeking platform connecting job seekers and companies using Flutter and Firebase, featuring OTP verification, Google Ads, and real-time listings. |
| **Smart Dustbin** | Patent | An IoT-based smart dustbin system that automates waste management and notifies authorities when full. |

---

- ⚙️ I'm currently working on: TypeScript, React, Node.js, AWS, Amazon Connect, Agentic AI for Voice, Flutter, NLP, AI/ML
